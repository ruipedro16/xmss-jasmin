...
module WOTS = {
  ...
  *)
  ...
  proc pkGen(sk_seed : nbytes, _seed : seed, address : adrs) : wots_pk = {
    ...
    (* Generate sk from the secret key *)
    wots_skey <@ pseudorandom_genSK(sk_seed, _seed, address); 
  ...
  *)
  ...
  proc sign_seed (M : wots_message, sk_seed : seed, pub_seed : seed, address : adrs) : wots_signature = {
    var wots_skey : wots_sk;
    var csum_32 : W32.t;
    var csum : int;
    var msg : int list;
