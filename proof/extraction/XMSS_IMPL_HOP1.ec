...
module M_Hop1(SC:Syscall_t) = {
  ...
  proc __thash_f (out:W8.t Array32.t, pub_seed:W8.t Array32.t,
    ...
    buf <- Array96.init
           (fun i_0 => if 0 <= i_0 < 0 + 32 then padding.[i_0-0]
           else buf.[i_0]);
  ...
  W8.t Array2144.t * W32.t Array8.t = {
    ...
    while (i < 67) {
      ...
      buf <- Array64.init
             (fun i_0 => if 32 <= i_0 < 32 + 32 then addr_bytes.[i_0-32]
             else buf.[i_0]);
    ...
    ith_seed <- _PRF_KEYGEN_ buf inseed;
      ...
      outseeds <- Array2144.init
                  ...
                  then ith_seed.[i_0-(i * 32)] else outseeds.[i_0]);
  ...
  proc __wots_sign (sig:W8.t Array2144.t, msg:W8.t Array32.t,
    ...
    while (i < 67) {
      ...
      (aux_0,
      aux_1) <@ __gen_chain_inplace_ ((Array32.init (fun i_0 => sig.[(i * 32) + i_0])),
  ...
  proc __wots_pk_from_sig (pk:W8.t Array2144.t, sig_ptr:W64.t,
    ...
    while (i < 67) {
      ...
      t <- sig_ptr;
      t <- (t + (W64.of_int (i * 32)));
      aux_0 <@ _x_memcpy_u8u8p ((Array32.init (fun i_0 => pk.[(i * 32) + i_0])),
      t);
      pk <- Array2144.init
            (fun i_0 => if (i * 32) <= i_0 < (i * 32) + 32
            then aux_0.[i_0-(i * 32)] else pk.[i_0]);
  ...
  proc __l_tree (leaf:W8.t Array32.t, wots_pk:W8.t Array2144.t,
    ...
    while (((W64.of_int 1) \ult l)) {
      ...
      while ((i \ult parent_nodes)) {
        ...
        bytes <- (W64.of_int 32);
        (buf0,  _0) <@ __memcpy_u8u8_2_32_2144 (buf0, wots_pk, offset_in,
        bytes);
        offset_in <- (i * (W64.of_int 2));
        offset_in <- (offset_in * (W64.of_int 32));
        bytes <- (W64.of_int (2 * 32));
        (buf1,  _1) <@ __memcpy_u8u8_2_64_2144 (buf1, wots_pk, offset_in,
        bytes);
      ...
      if ((t <> (W64.of_int 0))) {
        ...
        offset_out <- l;
        (_of_, _cf_, _sf_,  _2, _zf_, offset_out) <- SHR_64 offset_out
        (W8.of_int 1);
  ...
  proc __xmssmt_core_sign (sk:W8.t Array132.t, sm_ptr:W64.t, smlen_ptr:W64.t,
    ...
    if ((exit_0 <> (W8.of_int 1))) {
      ...
      buf <- _PRF_ buf idx_bytes sk_prf;
